...
public class SeasonHudForge {
  public SeasonHudForge() {
    ...
    NeoForgeConfigRegistry.get().INSTANCE.register(Common.MOD_ID, ModConfig.Type.CLIENT, SeasonHudClient.CLIENT_SPEC,
                                                   "seasonhud-client.toml");

    NeoForgeConfigRegistry.get().INSTANCE.register(Common.MOD_ID, ModConfig.Type.SERVER, SeasonHudServer.SERVER_SPEC,
